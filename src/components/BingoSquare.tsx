...
export const BingoSquare = forwardRef<HTMLButtonElement, Props>(function BingoSquare(
  ...
  return (
    <button
      ...
      className={cn(
        'relative flex aspect-square items-center justify-center rounded-lg border-2 p-1 text-center text-[11px] font-medium leading-tight transition-transform duration-150 sm:p-1.5 sm:text-xs',
